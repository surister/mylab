...
QUERIES_FAST = {
    'taxi': """
            ...
            """,
    'fast_taxi_nocolumnstore': """
            CREATE TABLE IF NOT EXISTS "doc"."fast_taxi_nocolumnstore"
            (
                "VendorID" BIGINT STORAGE WITH(columnstore = false),
                "tpep_pickup_datetime" TIMESTAMP WITHOUT TIME ZONE STORAGE WITH(columnstore = false),
                "tpep_dropoff_datetime" TIMESTAMP WITHOUT TIME ZONE STORAGE WITH(columnstore = false),
                ...
                "Airport_fee" REAL STORAGE WITH(columnstore = false)
                          ...
                          """,
    'fast_taxi_noindex': """
            CREATE TABLE IF NOT EXISTS "doc"."fast_taxi_noindex"
            (
                "VendorID"              BIGINT INDEX OFF,
                "tpep_pickup_datetime"  TIMESTAMP WITHOUT TIME ZONE INDEX OFF,
                "tpep_dropoff_datetime" TIMESTAMP WITHOUT TIME ZONE INDEX OFF,
            ...
            """,
    'fast_taxi_bestcompression': """
            CREATE TABLE IF NOT EXISTS "doc"."fast_taxi_bestcompression"
            (
                "VendorID"              BIGINT,
                "tpep_pickup_datetime"  TIMESTAMP WITHOUT TIME ZONE,
                "tpep_dropoff_datetime" TIMESTAMP WITHOUT TIME ZONE,
                ...
                "congestion_surcharge"  REAL,
                "Airport_fee"           REAL
            ) CLUSTERED INTO 1 SHARDS WITH (codec = 'best_compression', number_of_replicas = '0')
            """,
    'fast_taxi_noindex_nocolumnstore': """
                    CREATE TABLE IF NOT EXISTS "doc"."fast_taxi_noindex_nocolumnstore"
                    (
                        "VendorID"              BIGINT INDEX OFF STORAGE WITH(columnstore = false),
                        "tpep_pickup_datetime"  TIMESTAMP WITHOUT TIME ZONE INDEX OFF STORAGE WITH(columnstore = false),
                        "tpep_dropoff_datetime" TIMESTAMP WITHOUT TIME ZONE INDEX OFF STORAGE WITH(columnstore = false),
                    ...
                    """,
    'fast_taxi_noindex_bestcompression': """
                CREATE TABLE IF NOT EXISTS "doc"."fast_taxi_noindex_bestcompression"
                (
                    "VendorID"              BIGINT INDEX OFF,
                    "tpep_pickup_datetime"  TIMESTAMP WITHOUT TIME ZONE INDEX OFF,
                    "tpep_dropoff_datetime" TIMESTAMP WITHOUT TIME ZONE INDEX OFF,
                    ...
                    "congestion_surcharge"  REAL INDEX OFF,
                    "Airport_fee"           REAL INDEX OFF
                ) CLUSTERED INTO 1 SHARDS WITH (number_of_replicas = '0', codec = 'best_compression')
                """,
    'fast_taxi_nocolumnstore_bestcompression': """
                CREATE TABLE IF NOT EXISTS "doc"."fast_taxi_nocolumnstore_bestcompression"
                (
                    "VendorID" BIGINT STORAGE WITH(columnstore = false),
                    "tpep_pickup_datetime" TIMESTAMP WITHOUT TIME ZONE STORAGE WITH(columnstore = false),
                    "tpep_dropoff_datetime" TIMESTAMP WITHOUT TIME ZONE STORAGE WITH(columnstore = false),
                    ...
                    """,
    'fast_taxi_noindex_nocolumnstore_bestcompression': """
                CREATE TABLE IF NOT EXISTS "doc"."fast_taxi_noindex_nocolumnstore_bestcompression"
                (
                    "VendorID" BIGINT INDEX OFF STORAGE WITH(columnstore = false),
                    "tpep_pickup_datetime"  TIMESTAMP WITHOUT TIME ZONE INDEX OFF STORAGE WITH(columnstore = false),
                    "tpep_dropoff_datetime" TIMESTAMP WITHOUT TIME ZONE INDEX OFF STORAGE WITH(columnstore = false),
...
if __name__ == '__main__':
    ...
    with client:
        ...
        for name, query in QUERIES_FAST.items():
            ...
            print(f'Processed: {name} {cur._result}')
